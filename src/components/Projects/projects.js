		...
		<div className="skillsDiv">
			<header className="skillsHeader">
				<div className="skillsAndLine">
					<div className="skillsHeaderLeft">Projetcs</div>
					<div className="skillsDividerLine"></div>
				</div>
				<div className="skillsHeaderRight">I love building projects to practive my web skills, here are a couple of things that I've worked on.</div>
			</header>
